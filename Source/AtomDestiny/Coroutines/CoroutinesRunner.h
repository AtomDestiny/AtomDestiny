...
namespace AtomDestiny
{
    ...
    /// To start coroutine call RunCoroutine method. It will cache FVoidCoroutine.
    ...
    public:
        ...
        /// 
        [[maybe_unused]] TOptional<uint64_t> RunCoroutine(FVoidCoroutine&& coroutine, UObject* owner);
        [[maybe_unused]] bool StopCoroutine(const uint64_t id);
        void StopAllCoroutines();

    private:
        inline static uint64_t Id = 0;
        TMap<uint64_t, FVoidCoroutine> m_coroutines;
    };
} // namespace AtomDestiny
